 ...
 */
package org.openmrs.module.integratedhis2.web.controller;
 ...
 * 'module/integratedhis2/integratedhis2Link.form'.
 */
@Controller
@RequestMapping(value = "module/integratedhis2/integratedhis2Link.form")
public class IntegrateDHIS2FormController {
	
	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());
	
	/** Success form view name */
	private final String SUCCESS_FORM_VIEW = "/module/integratedhis2/integratedhis2Form";
